            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GestionClientes = table.Column<bool>(type: "bit", nullable: false),
                    GestionVentas = table.Column<bool>(type: "bit", nullable: false),
                    GestionProductos = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
